...
| Goliath (Gulayat) | `@goliath` | `character_assets/@goliath.png` | 1.86× base; **~2× shoulder width**; David's crown ≈ his navel, Saul's crown ≈ his mid-chest, shield-bearer's crown ≈ his belt line, his kneecap ≈ a man's hip, his hanging elbow ≈ just above a man's crown. **Ceiling: a little under 2× a man's height** — copy the full [scale cage](../crs_table_Goliath_Complex.md#the-scale-cage-bounding-a-giant) into every shot he shares | heavyweight mass (mass, not just height); coppery-bronze fish-scale lamellar cuirass, bronze pauldrons w/ central boss, engraved vambraces, greaves; heavy brow, thick dark beard; domed bronze helmet (flies off Clip 89). **Prompt text says "a giant of a man built on human proportions" — never *colossal / monumental / towering / earth-shaking*; those inflate him mid-shot** | final |
...
| Goliath's tower shield | `@goliath_shield` | — not filed (**v1/v3 too small, v2 far too large — v4 pending**) | **≈1.35× the bearer's height, ceiling 1.5×:** lower rim at his ankles, top rim ~2.5 head-heights above his crown, so **his crown reaches only ~7/10 of the way up the shield**; width ≈ twice his shoulder span; aspect ≈ 2.5:1 | carried by the shield-bearer; **v3's design is the accepted look** — vertical wood planks under a bronze spine + cross-band, domed boss ≈ ¼ of the width, dark patina; strap + grip sized to a normal forearm and spanning only ~⅓ of the width, **empty — no glove, hand or arm**. ⚠️ **Three size failures: v1 fitted to the bearer; v2 ~4–5× too large; v3 ~0.85× (the "Roman scutum / Norman kite" size-class analogue was man-sized and beat every ratio line).** ⚠️ **The referenceable sheet contains NO human figure** — a figure baked into a prop sheet bleeds into video generations; the scale proof is a separate QA-only image, never uploaded. Re-generate at the v4 spec ([prop file §2](../Goliath%20Complex%20-%20Prop%20Assets_%20Descriptions%20&%20Prompts.md)), file as `@goliath_shield_v4.png`, tag unchanged. Until v4 lands, prompts must restate **both** the oversize *and* the 7/10 crown landmark | final |
